...
public class Menu {
    ...
    private void comprarEntrada() {
        ...
        System.out.print("Ingresa fila (A/B/C): ");
        String filaStr = sc.nextLine();
        if (filaStr.isEmpty() || !filaStr.matches("[ABCabc]")) {
            System.out.println("Fila inválida.");
            return;
        }
        char fila = Character.toUpperCase(filaStr.charAt(0));

        System.out.print("Ingresa número (1-6): ");
        if (!sc.hasNextInt()) {
